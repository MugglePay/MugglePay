...
For existing projects, you can integrate MugglePay directly using the REST API. No additional packages are required - just use standard HTTP requests to our API endpoints.
